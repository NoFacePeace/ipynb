...
if __name__ == "__main__":
    ...
    for i, pair in enumerate(feature_pairs):
        ...
        print('特征：  ', iris_feature[pair[0]], ' + ', iris_feature[pair[1]], end='')   #python3用end=""来不换行，python2用,代表不换行 print(xxx,bbb,)
        print('\t预测正确数目：', c, end='')
        ...
        plt.xlabel(iris_feature[pair[0]]+str(100 * float(c) / float(len(y))), fontsize=14)
